...
"Step 3: Click on div 'footerPanel'"

WebUI.takeScreenshot()

WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_parabank_index_htm/div_footerpanel'), 20, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/parabank/index.htm?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_parabank_index_htm/div_footerpanel'))

"Step 4: Enter input value in input field 'username'"
...
"Step 5: Enter input value in input field 'password'"
...
"Step 6: Click on input field  -> Navigate to page 'parabank/login.htm'"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC3-Verify Login and Page Navigation at Parabank Login_visual_checkpoint')
